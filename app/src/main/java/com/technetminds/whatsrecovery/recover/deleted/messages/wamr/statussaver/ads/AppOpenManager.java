...
import com.technetminds.whatsrecovery.recover.deleted.messages.wamr.statussaver.Activities.SplashScreenActivity;
...
public class AppOpenManager implements LifecycleObserver, Application.ActivityLifecycleCallbacks{
    ...
    public void fetchAd() {
        ...
        AppOpenAd.load(myApplication, myApplication.getString(R.string.app_open), request,
